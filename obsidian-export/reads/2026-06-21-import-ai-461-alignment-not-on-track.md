---
title: "Import AI 461: Alignment is not on track"
title_zh: "Import AI 461：对齐不在正轨——来自前沿实验室内部人的罕见直白判断"
author: "Jack Clark"
author_title: "Anthropic 联合创始人、前 OpenAI 政策主管，Import AI newsletter 作者"
publish_date: 2026-06-15
saved_date: 2026-06-21
original_url: "https://importai.substack.com/p/import-ai-461-alignment-is-not-on"
slug: "2026-06-21-import-ai-461-alignment-not-on-track"
source: "importai.substack.com"
fetch_status: "ok"
fetched_at: "2026-06-21T01:15:48.171Z"
fetch_type: "html"
...
*Jack Clark*
> 🔗 原文：[https://importai.substack.com/p/import-ai-461-alignment-is-not-on](https://importai.substack.com/p/import-ai-461-alignment-is-not-on)
---
...
**_…Sequent will have a portfolio of under-resourced research bets…  
_Researchers from the UK AI Security Institute Alignment team as well as alignment theory startup [Timaeus](https://timaeus.co/) have joined forces to form a new nonprofit research organization, Sequent, which will try to create alignment techniques that give us higher confidence in the safety of superintelligent AI systems.  
...
**Read more:** [ChinaHeritaQA: A Culturally-Grounded Visual Question Answering Dataset for World Heritage Sites in China (arXiv)](https://arxiv.org/abs/2606.08959).  
**Get the [dataset](https://github.com/boleima/ChinaHeritaQA)** [(ChinaHeritaQA, GitHub)](https://github.com/boleima/ChinaHeritaQA).

\*\*\*

**FrontierCode - a hard coding benchmark that tests for code quality:  
**_…Reassuringly hard. Maybe it’ll last a year?...  
_Cognition, makers of Devin, have built a new hard coding benchmark called FrontierCode. The best part about the benchmark is how hard it is - Claude Opus 4.8 gets a score of 13.4% on the hardest (”Diamond”) component of the benchmark, giving me some confidence that FrontierCode will be a useful way to assess progress of AI systems in the coming years.  
...
**Read more:** [Act As a Real Researcher: A Suite of Benchmarks Evaluating Frontier LLMs and Agentic Harnesses in Research Lifecycle (arXiv)](https://arxiv.org/abs/2606.07462).

\*\*\*

**Tech Tales:**Hunter & Warden

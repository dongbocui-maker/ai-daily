...
title_zh: "Agentic Coding 与专长的持续回报：来自 40 万个 Claude Code 真实会话的研究"
author: "Anthropic Research"
author_title: "Anthropic 研究团队"
publish_date: 2026-06-17
saved_date: 2026-06-21
original_url: "https://www.anthropic.com/research/claude-code-expertise"
slug: "2026-06-21-anthropic-agentic-coding-expertise"
source: "anthropic.com"
fetch_status: "ok"
fetched_at: "2026-06-21T01:15:44.672Z"
fetch_type: "html"
content_length: 26099
tags:
  - "Agentic-Coding"
  - "Claude-Code"
  - "领域专长"
...
This report provides evidence on how Claude Code is used in practice, based on a [privacy-preserving analysis](https://www.anthropic.com/research/clio) of ~400,000 interactive sessions from ~235,000 people between October 2025 and April 2026. It builds on prior work focused on [measures of autonomy](https://www.anthropic.com/research/measuring-agent-autonomy) in Claude Code sessions, and [how Claude Code is changing work at Anthropic](https://www.anthropic.com/research/how-ai-is-transforming-work-at-anthropic).3 Here, we introduce a framework for describing interactive AI coding-assistant usage: what kind of work is being done, who is doing it, and whether it succeeds. We focus on Claude Code usage through a command-line interface (CLI), [Claude.ai](http://claude.ai/redirect/website.v1.d51427cf-a669-4a6c-abc9-3e05a0c2d29e), or the Claude Code desktop app.4 By tracking how agentic coding usage changes as models get more capable, we can better understand how these tools affect the labor market for coding professionals and knowledge workers.
...
**The examples paraphrase, anonymize and condense real sessions labeled by our classifiers. Many of the sessions used in the table come from a public dataset of agentic coding sessions, [SWE-chat](https://huggingface.co/datasets/SALT-NLP/SWE-chat).  
...
**The examples paraphrase and summarize real sessions from a public dataset of agentic coding interactions, [SWE-chat](https://huggingface.co/datasets/SALT-NLP/SWE-chat), labeled by our classifiers.

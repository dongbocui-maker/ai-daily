...
1. Agent 开始访问 **PII / PHI / PCI / 财务数据 / 客户数据**

1. Agent 数量 ≥ 10 个，或部署在 ≥ 3 个业务部门

1. 面临 **GDPR / HIPAA / 欧盟 AI Act / NIST AI RMF / SOX** 中任一框架的合规审查
...
- **方法**：跨云/SaaS/本地环境**发现所有 agent** + 标记为 digital identity + 应用最小特权
